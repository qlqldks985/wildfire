...
MODEL_PATH = 'runs/detect/fire_master_model/weights/best.pt'  # 👈 아까 완료된 train-7 경로로 반영했습니다.

ESP32_URL = "http://192.168.137.245:81/stream"
...
if not cap.isOpened():
    ...
    print("   3. 브라우저에서 http://192.168.137.245:81/stream 열리는지 테스트")
    exit()
